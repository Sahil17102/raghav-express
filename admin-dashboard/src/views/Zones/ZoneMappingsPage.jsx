...
const ZoneMappingsPage = () => {
  ...
  const csvHeaders = isB2B
    ...
    : [{ pincode: '', city: '', state: '' }]
  return (
    <Flex direction="column" pt={{ base: '12px', md: '4px' }} gap={6}>
      {/* Header */}
            ...
            <Alert status="info" variant="subtle" borderRadius="md">
              ...
              <AlertDescription fontSize="sm">
                ...
                <Text as="span" fontSize="xs" display="block" ml={4}>
                  â€¢ is_oda â€¢ is_remote â€¢ is_mall â€¢ is_sez â€¢ is_airport â€¢ is_high_security
                </Text>
              ...
              >
                ...
                <Box flex={2}>
                  <Text>
                    ...
                    â†’ <span style={{ color: 'green' }}>{d.newMapping.city}</span>
                  </Text>
                  <Text>
                    <b>State:</b>{' '}
                    <span
                    ...
                    â†’ <span style={{ color: 'green' }}>{d.newMapping.state}</span>
                  </Text>
                </Box>
                <Box flex={1}>
                  <Select
