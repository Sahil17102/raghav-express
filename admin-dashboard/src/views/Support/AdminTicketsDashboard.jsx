...
const renderers = {
  dueDate: (value, row) => {
    if (!value) return <Text color="gray.400">â€”</Text>
          ...
          <>
            ...
            <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6} mb={6}>
              ...
              <Box p={3} borderRadius="md" bg="gray.50">
                ...
                <Text>{selectedTicket.subcategory || 'â€”'}</Text>
              </Box>
              ...
              <Box p={3} borderRadius="md" bg="gray.50">
                ...
                <Text>{selectedTicket.awbNumber || 'â€”'}</Text>
              </Box>
              ...
              <Box p={3} borderRadius="md" bg="gray.50">
                ...
                <Text fontWeight="medium">
                  {selectedTicket.dueDate ? new Date(selectedTicket.dueDate).toLocaleString() : 'â€”'}
                </Text>
              </Box>
