...
const AboutUsEditor = () => {
  ...
  const handleLoadTemplate = () => {
    const templateHtml = `
      <h2>About Raghav Express</h2>
      <p><strong>Raghav Express</strong> is a courier and cargo platform designed to help entrepreneurs, D2C brands, and logistics businesses run shipping operations with a clean and scalable software stack.</p>
      ...
      <p><strong>Email:</strong> raghavexpresspali@gmail.com</p>
      <p><strong>Website:</strong> Raghav Express</p>
    `
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updatePageMutation.mutateAsync({ title: 'About Us - Raghav Express', content })
      toast({
  ...
  return (
    <Box pt={{ base: '12px', md: '4px' }} bg={bgColor} minH="100vh" pb={10}>
      <Box
