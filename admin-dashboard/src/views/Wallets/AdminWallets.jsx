...
export default function AdminWallets() {
  ...
  const getCompanyName = (companyInfo) => {
    if (!companyInfo) return 'â€”'
    return companyInfo.brandName || companyInfo.businessName || companyInfo.name || 'â€”'
  }

  const getContactPerson = (companyInfo) => {
    if (!companyInfo) return 'â€”'
    return companyInfo.contactPerson || 'â€”'
  }
    ...
    <Flex direction="column" pt={{ base: '12px', md: '4px' }}>
      ...
      <GenericTable
        ...
        renderers={{
          user: (value, row) => {
            ...
            return (
              <Stack direction="row" alignItems="center" gap={2}>
                <Avatar
                  name={contactPerson !== 'â€”' ? contactPerson : companyName}
                  size="sm"
          ...
          userEmail: (value) => <Text>{value || 'â€”'}</Text>,
          balance: (value) => {
