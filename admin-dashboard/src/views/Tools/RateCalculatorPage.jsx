...
export default function RateCalculatorPage() {
  ...
  const getCourierDisplayName = (courier) => courier?.displayName || courier?.name || 'â€”'
    ...
    shipmentType === 'b2b'
      ? {
          ...
          renderers: {
            ...
            demurrage: (val) => (val > 0 ? formatCurrency(val) : 'â€”'),
            total: (val) => (
            ...
            overheadDetails: (value, row) => {
              ...
              return parts.length > 0 ? <Box>{parts}</Box> : <Text>â€”</Text>
            },
          },
        }
      : {
          ...
          renderers: {
            ...
            max_slab_weight: (val) => (val != null ? `${val} kg` : 'â€”'),
          ...
          >
            ...
            <Box px={4} py={4}>
              <Stack spacing={2}>
                ...
                <Text color="gray.500">Zone {highlights.cheapest?.approxZone?.code || 'â€”'}</Text>
          ...
          >
            ...
            <Box px={4} py={4}>
              <Stack spacing={2}>
                ...
                <Text color="gray.500">Zone {highlights.fastest?.approxZone?.code || 'â€”'}</Text>
                <Text fontSize="xl" fontWeight="bold" color="purple.500">
                  {highlights.fastest?.edd || 'â€”'}
                </Text>
