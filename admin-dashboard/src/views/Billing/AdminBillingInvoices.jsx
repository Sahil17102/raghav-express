    ...
    try {
      ...
      toast({
        ...
        description: statement
          ? `Net adjustment: ${statement.additions.adjustments >= 0 ? '+' : ''}â‚¹${Number(
              statement.additions.adjustments || 0,
            ).toFixed(2)} | Outstanding: â‚¹${Number(statement.outstanding || 0).toFixed(2)}`
          : undefined,
      })
        ...
        {isLoading ? (
          ...
          <>
            <GenericTable
              ...
              sortByComponent={
                <Tooltip
                  label="COD remittances auto-apply as COD offsets to oldest pending invoice (once per remittance). Invoices autoâ€‘mark Paid when outstanding is 0."
                  hasArrow
                >
                  <IconButton
              ...
              data={(data?.data || []).map((inv) => ({
                ...inv,
                period: `${new Date(inv.billingStart).toLocaleDateString()} â†’ ${new Date(
                  inv.billingEnd,
                ).toLocaleDateString()}`,
                generatedAt: inv.createdAt,
                totalAmount: `â‚¹${Number(inv.totalAmount).toFixed(2)}`,
                actions: (
                  <Wrap spacing={2}>
                    <IconButton
                      aria-label="Open PDF"
                  ...
                  {orderRows.map((r) => (
                    <tr key={r.id}>
                      ...
                      <td style={{ padding: 6, textAlign: 'right' }}>
                        â‚¹{Number(r.freight_charges || 0).toFixed(2)}
                      </td>
                      <td style={{ padding: 6, textAlign: 'right' }}>
                        â‚¹{Number(r.cod_charges || 0).toFixed(2)}
                      </td>
                      <td style={{ padding: 6, textAlign: 'right' }}>
                        <Input
                          placeholder="0"
              ...
              >
                ...
                <Stack spacing={2}>
                  <HStack justify="space-between">
                    ...
                    <Text fontSize="sm" fontWeight="600">
                      â‚¹{statementData.totals.taxableValue.toFixed(2)}
                    </Text>
                  </HStack>
                  {statementData.totals.taxBreakup.cgst > 0 && (
                    <HStack justify="space-between">
                      ...
                      <Text fontSize="sm" fontWeight="600">
                        â‚¹{statementData.totals.taxBreakup.cgst.toFixed(2)}
                      </Text>
                    </HStack>
                  )}
                  {statementData.totals.taxBreakup.sgst > 0 && (
                    <HStack justify="space-between">
                      ...
                      <Text fontSize="sm" fontWeight="600">
                        â‚¹{statementData.totals.taxBreakup.sgst.toFixed(2)}
                      </Text>
                    </HStack>
                  )}
                  <Divider />
                  <HStack justify="space-between">
                    ...
                    <Text fontSize="md" fontWeight="700" color="blue.600">
                      â‚¹{statementData.totals.netPayable.toFixed(2)}
                    </Text>
                  </HStack>
                </Stack>
              </Box>
                ...
                >
                  ...
                  <Stack spacing={2}>
                    {statementData.additions.credits > 0 && (
                      <HStack justify="space-between">
                        ...
                        <Text fontSize="sm" fontWeight="600" color="green.600">
                          -â‚¹{statementData.additions.credits.toFixed(2)}
                        </Text>
                      </HStack>
                    )}
                    {statementData.additions.waivers > 0 && (
                      <HStack justify="space-between">
                        ...
                        <Text fontSize="sm" fontWeight="600" color="green.600">
                          -â‚¹{statementData.additions.waivers.toFixed(2)}
                        </Text>
                      </HStack>
                    )}
                    {statementData.additions.debits > 0 && (
                      <HStack justify="space-between">
                        ...
                        <Text fontSize="sm" fontWeight="600" color="red.600">
                          +â‚¹{statementData.additions.debits.toFixed(2)}
                        </Text>
                      </HStack>
                    )}
                    {statementData.additions.surcharges > 0 && (
                      <HStack justify="space-between">
                        ...
                        <Text fontSize="sm" fontWeight="600" color="red.600">
                          +â‚¹{statementData.additions.surcharges.toFixed(2)}
                        </Text>
                      </HStack>
                    )}
                    <Divider />
                    <HStack justify="space-between">
                      ...
                      >
                        {statementData.additions.adjustments >= 0 ? '+' : ''}â‚¹
                  ...
                  <Stack spacing={2}>
                    ...
                    <HStack justify="space-between">
                      ...
                      <Text fontSize="md" fontWeight="700" color="green.600">
                        â‚¹{statementData.payments.received.toFixed(2)}
                      </Text>
                    </HStack>
                  </Stack>
                </Box>
                ...
                >
                  ...
                  <HStack justify="space-between">
                    ...
                    <Text fontSize="md" fontWeight="700" color="teal.600">
                      â‚¹{statementData.offsets.codOffsets.toFixed(2)}
                    </Text>
                  </HStack>
                </Box>
              )}
              ...
              >
                <HStack justify="space-between" align="center">
                  <VStack align="start" spacing={1}>
                    ...
                    >
                      â‚¹{statementData.outstanding.toFixed(2)}
                    </Text>
                  </VStack>
