...
export const GenericTable = ({
  ...
  const headerBg = useColorModeValue('#EEF4FB', '#121B31')
  const headerColor = useColorModeValue('brand.700', 'gray.300')
  ...
  return (
    <Card overflow="visible" bg={shellBg} borderRadius="8px" borderLeft="3px solid" borderLeftColor="brand.500">
